...
RSpec.describe BroadcastsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested broadcast as @broadcast" do
      broadcast = Broadcast.create! valid_attributes
      get :show, params: {id: broadcast.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested broadcast as @broadcast" do
      broadcast = Broadcast.create! valid_attributes
      get :edit, params: {id: broadcast.to_param}, session: valid_session
      expect(assigns(:broadcast)).to eq(broadcast)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Broadcast" do
        expect {
          post :create, params: {broadcast: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved broadcast as @broadcast" do
        post :create, params: {broadcast: invalid_attributes}, session: valid_session
        expect(assigns(:broadcast)).to be_a_new(Broadcast)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested broadcast" do
        broadcast = Broadcast.create! valid_attributes
        put :update, params: {id: broadcast.to_param, broadcast: new_attributes}, session: valid_session
        broadcast.reload
      ...
      it "assigns the requested broadcast as @broadcast" do
        broadcast = Broadcast.create! valid_attributes
        put :update, params: {id: broadcast.to_param, broadcast: valid_attributes}, session: valid_session
        expect(assigns(:broadcast)).to eq(broadcast)
      end
    ...
    context "with invalid params" do
      it "assigns the broadcast as @broadcast" do
        broadcast = Broadcast.create! valid_attributes
        put :update, params: {id: broadcast.to_param, broadcast: invalid_attributes}, session: valid_session
        expect(assigns(:broadcast)).to eq(broadcast)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested broadcast" do
      broadcast = Broadcast.create! valid_attributes
      expect {
        delete :destroy, params: {id: broadcast.to_param}, session: valid_session
      }.to change(Broadcast, :count).by(-1)
    end
